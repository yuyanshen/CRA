...
WebUI.click(findTestObject('Object Repository/Page_CRA/a_AP EO Notification info'))
...
WebUI.setText(findTestObject('Object Repository/Page_CRA/input_APEON title_p-inputtext p-component'), 'APEONTEST')

WebUI.click(findTestObject('Object Repository/Page_CRA/APEON_label_Start date'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_CRA/span_21'))

WebUI.click(findTestObject('Object Repository/Page_CRA/APEON_label_End date'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Page_CRA/button_Finish'))
